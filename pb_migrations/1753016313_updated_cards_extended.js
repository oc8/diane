...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_XDfg")

  // remove field
  collection.fields.removeById("_clone_a10m")

  // remove field
  collection.fields.removeById("_clone_wto6")

  // remove field
  collection.fields.removeById("_clone_lQbB")

  // remove field
  collection.fields.removeById("_clone_rJlA")

  // remove field
  collection.fields.removeById("_clone_4Zv0")

  // remove field
  collection.fields.removeById("_clone_kVNA")

  // remove field
  collection.fields.removeById("_clone_QoPX")

  // remove field
  collection.fields.removeById("_clone_Q4YZ")

  // remove field
  collection.fields.removeById("_clone_eKuQ")

  // remove field
  collection.fields.removeById("_clone_ekcq")

  // remove field
  collection.fields.removeById("_clone_GvgS")

  // remove field
  collection.fields.removeById("_clone_abxx")

  // remove field
  collection.fields.removeById("_clone_Ys8F")

  // remove field
  collection.fields.removeById("json2859962647")
