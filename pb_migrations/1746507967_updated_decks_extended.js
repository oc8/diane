...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_EJSn")

  // remove field
  collection.fields.removeById("_clone_f6ry")

  // remove field
  collection.fields.removeById("_clone_hQRv")

  // remove field
  collection.fields.removeById("_clone_YpWo")

  // remove field
  collection.fields.removeById("_clone_1YpC")

  // remove field
  collection.fields.removeById("_clone_BbEC")

  // remove field
  collection.fields.removeById("_clone_lUBJ")

  // remove field
  collection.fields.removeById("_clone_iKeF")

  // remove field
  collection.fields.removeById("_clone_oO8t")

  // remove field
  collection.fields.removeById("_clone_27Rw")
